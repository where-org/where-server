const at = {
  ...
  '@me': async (ref, config, where, name, condition) => {
    return ref.user ? [ref.user] : [];
  },

  '@spec': async (ref, config, where, name, condition) => {
  ...
  '@schema': async (ref, config, where, name, condition) => {

    const [spec] = await at['@spec'](ref, config, where, name, null),
  ...
  '@condition': async (ref, config, where, name, condition) => {
